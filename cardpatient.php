    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a href="#analyses" class="nav-link" data-bs-toggle="collapse" data-bs-target="#analyses-collapse" aria-expanded="false" aria-controls="analyses-collapse">
              <i class="fas fa-flask"></i> Анализы
            </a>
          </li>
          <li class="nav-item">
            <a href="#doctorNotes" class="nav-link" data-bs-toggle="collapse" data-bs-target="#doctorNotes-collapse" aria-expanded="false" aria-controls="doctorNotes-collapse">
